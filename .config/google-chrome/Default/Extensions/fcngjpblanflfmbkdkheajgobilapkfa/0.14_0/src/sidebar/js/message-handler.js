...
function handleStoreReviewChat() {
    $('#messages').prepend('' +
        ...
        '<span class="sender dev">PrimeParty</span>' +
        '<div class="chat-tip"></div>' +
        '<div class="chat notification">' +
            'Hi there! Thank you for using this plugin.' +
            'Can you help me by leaving a review on the web store, so more people can enjoy this plugin? Thanks a ton!' +
            '<a href="https://chrome.google.com/webstore/detail/prime-video-party/eingklpogjmofcedolfbgoomghkaamkn/reviews" target="_blank" class="review-button store">Review</a>' +
